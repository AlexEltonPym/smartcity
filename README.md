...
*yarrabiliba-docbyword.csv*

The TDMs are automatically generated by analysis programs. They are arranged with documents as collumns and words as rows.

### JSONs (General document data)

*processedTwitterData.json*
